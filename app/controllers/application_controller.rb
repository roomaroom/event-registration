class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) << :name << :mobile << :city << :community << :email << :sex << :birthday << :first_name << :last_name
    devise_parameter_sanitizer.for(:sign_in) << :login << :password << :email << :sex << :birthday << :first_name << :last_name
    devise_parameter_sanitizer.for(:account_update) << :name << :mobile << :city << :community << :email << :sex << :birthday << :first_name << :last_name
  end
